...
function PetActionGrid({ pet, onThought, onChat, t, g, actions: customActions }) {
    const defaultActions = [
        ...
        { key: "chat",       icon: "chatbubble-outline",       label: "Chat",       bg: t.colors.third,     text: t.colors.textOverThird,    onPress: () => onChat(pet) },
        { key: "thought",    icon: "bulb-outline",             label: "Thought",   bg: t.colors.fourth,      text: t.colors.textOverFourth,      onPress: () => onThought(pet) },
    ];
            ...
            {actions.map((action) => {
                ...
                return (
                    ...
                    >
                        ...
                        <Text style={{ fontSize: 11, fontWeight: "600", color: text, textAlign: "center" }} numberOfLines={2}>
                            {action.label}
                        </Text>
                    </Pressable>
                );
